...
If the default styles conflict with your styles, you can override them by copying the `/styles_v2.XXX/core.css` file to the `/custom/styles/core.css` and making changes to it.
