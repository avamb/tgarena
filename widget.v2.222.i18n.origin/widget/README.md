...
* **One event** `/widget/#/`
	...
	* `success`: URL to redirect on successful purchase (default: https://bilw.ru/pay_s.html)
	* `fail`: URL to redirect on failed purchase (default: https://bilw.ru/pay_f.html)
	* `agr`: Offer page URL (default: https://bilw.ru/agreement.html)
...
- - -
© 2022 consta.prokhorov - BIL24. All Rights Reserved.
