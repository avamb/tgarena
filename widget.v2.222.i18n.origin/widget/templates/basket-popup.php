		...
		<div class="basketFull-content" ng-show="!fullBasket.loading">
			...
			<div class="basketFullBottom" ng-show="miniBasket.tickets > 0">
				...
				<form class="basketFullBottom-agreement">
					<div class="agreement" ng-show="translate.menu.agreement">
					...
					<div class="text-center">
						...
						<button class="btn btn-info" ng-click="CreateOrder()" ng-disabled="!checkAgree || (config.terms.fullName.required && !config.terms.fullName.value) || (config.terms.phone.required && !config.terms.phone.value)">{{translate.basket.full.buy_button}}</button>
					</div>
				</form>
			</div>
		</div>
