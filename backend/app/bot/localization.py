...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "error_widget_not_configured": "Покупка билетов временно недоступна. Попробуйте позже.",

        # Purchase flow
        "select_session": "🎫 <b>{event_name}</b>\n\nВыберите сеанс:",
        "select_category": "🎫 Выберите категорию билетов:",
        "select_quantity": "🎫 <b>{category}</b> — {price} {currency}\n\nВыберите количество (макс. {max_qty}):",
        ...
        "purchase_cancelled": "❌ Покупка отменена. Места освобождены.",
        "reservation_expiring_soon": "⚠️ Ваша бронь истекает через 2 минуты! Оплатите заказ.",
        "reservation_expired": "⏰ Время бронирования истекло. Места освобождены.\nНачните покупку заново.",
        "error_no_sessions": "К сожалению, для этого мероприятия нет доступных сеансов.",
        "error_no_seats_available": "Нет свободных мест для выбранного сеанса.",
        "error_create_order_failed": "Не удалось создать заказ. Попробуйте позже.",
        "error_bill24_session": "Сессия истекла, попробуйте ещё раз.",
    ...
    "en": {
        ...
        "event_details": "<b>{name}</b>\n\n📅 Date: {date}\n📍 Venue: {venue}\n💰 Price: {min_price} - {max_price} {currency}\n{age_restriction}{countdown}",
        ...
        "error_widget_not_configured": "Ticket purchase is temporarily unavailable. Please try again later.",
        ...
        "purchase_cancelled": "❌ Purchase cancelled. Seats released.",
        "reservation_expiring_soon": "⚠️ Your reservation expires in 2 minutes! Please pay now.",
        "reservation_expired": "⏰ Reservation expired. Seats released.\nPlease start the purchase again.",
        "error_no_sessions": "Sorry, no available sessions for this event.",
        "error_no_seats_available": "No available seats for the selected session.",
        "error_create_order_failed": "Failed to create order. Please try again later.",
        "error_bill24_session": "Session expired, please try again.",
